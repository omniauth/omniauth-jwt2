...
# omniauth-jwt2 Rakefile v7.0.0 - 2026-06-15
...
# rake install                                # Build and install omniauth-jwt2-1.0.0.gem in...
# rake install:local                          # Build and install omniauth-jwt2-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template omniauth-jwt2 against itse...
