...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/omniauth/omniauth-jwt2"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://omniauth-jwt2.galtzo.com"
  ...
  # The 'git' gem is optional; omniauth-jwt2 falls back to shelling out to `git` if it is not present.
